...
const MyArtCraftCard = ({ item, handleDeleteCraft }) => {
  const {
    itemPhotoUrl,
    itemName,
    customizationStatus,
    ...
    <div className='font-montserrat cursor-pointer card card-compact bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-xl rounded-lg overflow-hidden transform transition duration-500 hover:scale-105'>
      ...
      <div className='card-body p-4 text-center'>
        ...
        <div className='card-actions flex justify-between mt-4'>
          ...
          <button className='btn btn-primary bg-blue-400 hover:bg-blue-800 text-white flex items-center gap-2'>
            <Link to={`/crafts/${_id}`}>
          ...
          <button
            ...
            className='btn btn-primary bg-red-700 hover:bg-red-800 text-white flex items-center gap-2'
          >
